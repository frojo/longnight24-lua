...
local function SendPokemonInfo()
	-- Define descriptive attributes of the custom extension that are displayed on the Tracker settings
	local self = {}
	self.version = "1.0"
	self.name = "Send Pokemon Info"
	self.author = "fran"
	self.description = "sends pokemon info"
	...
	function self.afterProgramDataUpdate()
		-- [ADD CODE HERE]
		local mon = TrackerAPI.getPlayerPokemon(1)

		print(mon.nickname)
		print(string.format("%s", mon.pokemonID))
